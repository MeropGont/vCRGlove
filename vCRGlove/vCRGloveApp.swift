...
let Translations: [String: [String: String]] = [
    ...
    "Wear the watch on your %@ arm and keep the watch app open.": ["de": "Tragen Sie die Uhr am %@ Arm und halten Sie die Watch-App geöffnet."],
    ...
    "Great job. Your vCR session is complete for today.": ["de": "Gut gemacht. Ihre vCR-Sitzung für heute ist abgeschlossen."],

    "Session interrupted because both gloves disconnected.": ["de": "Sitzung unterbrochen, weil beide Handschuhe getrennt wurden."],

    "vCR timing may have been interrupted while the app was not open.": ["de": "Die vCR-Zeitsteuerung wurde möglicherweise unterbrochen, während die App nicht geöffnet war."],

    "Keep this app open during stimulation.": ["de": "Halten Sie die App während der Stimulation geöffnet."],

    "Paused": ["de": "Pausiert"],

    "Stimulation running": ["de": "Stimulation läuft"],

    "Time remaining": ["de": "Verbleibende Zeit"],

    "Connect at least one glove to begin": ["de": "Verbinden Sie mindestens einen Handschuh, um zu beginnen"],

    "%d h vCR session": ["de": "%d h vCR-Sitzung"],

    "Start vCR": ["de": "vCR starten"],

    "Something not working?": ["de": "Funktioniert etwas nicht?"],

    "Resume": ["de": "Fortsetzen"],

    "Pause": ["de": "Pause"],

    "Hold to Stop": ["de": "Zum Stoppen halten"],

    "STOP SCAN": ["de": "SCAN STOPPEN"],

    "SCAN FOR GLOVES": ["de": "NACH HANDSCHUHEN SUCHEN"],

    "Left glove": ["de": "Linker Handschuh"],

    "Right glove": ["de": "Rechter Handschuh"],

    "Tap to test buzz": ["de": "Tippen, um Buzz zu testen"],

    "Scan and connect gloves before starting.": ["de": "Suchen und verbinden Sie vor dem Start Handschuhe."],

    "%d glove(s) ready.": ["de": "%d Handschuh(e) bereit."],

    "vCR session started with %d glove(s)": ["de": "vCR-Sitzung mit %d Handschuh(en) gestartet"],

    "Sessions": ["de": "Sitzungen"],

    "Trials": ["de": "Messungen"],

    "Recorded data": ["de": "Aufgezeichnete Daten"],

    "Export": ["de": "Exportieren"],

    "Files are saved to vcr/tasks/exports and can also be accessed from the Files app.": ["de": "Dateien werden in vcr/tasks/exports gespeichert und können auch über die Dateien-App aufgerufen werden."],

    "JSON (full sessions)": ["de": "JSON (vollständige Sitzungen)"],

    "CSV — metrics per trial": ["de": "CSV — Kennzahlen pro Messung"],

    "CSV — raw samples": ["de": "CSV — Rohdaten"],

    "Last export": ["de": "Letzter Export"],

    "File": ["de": "Datei"],

    "Share…": ["de": "Teilen…"],

    "Movement Data Export": ["de": "Bewegungsdaten-Export"]
]
